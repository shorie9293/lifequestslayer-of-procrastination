...
void main() {
  ...
  group('TitleDefinition.getProgress', () {
    ...
    test('「見習い冒険者」は totalTasksCompleted を参照する', () {
      final player = Player().copyWith(totalTasksCompleted: 7);
    ...
    test('「鬼退治」は totalBRankCompleted を参照する', () {
      final player = Player().copyWith(totalBRankCompleted: 30);
    ...
    test('「大物祓い」は totalARankCompleted を参照する', () {
      final player = Player().copyWith(totalARankCompleted: 20);
    ...
    test('「龍神討ち」は totalSRankCompleted を参照する', () {
      final player = Player().copyWith(totalSRankCompleted: 5);
