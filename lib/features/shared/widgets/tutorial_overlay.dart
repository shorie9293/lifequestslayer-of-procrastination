                ...
                Positioned(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (_, __) => Transform.translate(
                      offset: Offset(
                          0, (showArrowAbove ? 1 : -1) * _pulseAnim.value * 6),
                      child: Text(
                        showArrowAbove ? '👇' : '👆',
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: widget.dialogColor, width: 2),
                              ),
                              child: Text(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(color: widget.dialogColor, width: 3),
                          ),
                          child: Text(
                            widget.message,
                            style: const TextStyle(
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
          pulseRect, Radius.circular(holeRadius + pulseProgress * 4)),
      pulsePaint,
    );
  }
