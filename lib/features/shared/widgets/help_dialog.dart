    ...
    return (
      ...
      [
        ...
        (
          Icons.checklist,
          '眷属神託（サブクエスト）の完遂',
          '神託に眷属神託（サブクエスト）が紐づいている場合、それらを全て達成してからでないと本体は討伐できません。\n'
    ...
    return (
      ...
      [
        ...
        (
          Icons.home_work,
          '町の発展と町XP',
          'クエストを討伐すると町XPを獲得でき、町レベルが上昇します。\n'
              '町レベルが上がると新たな建物が解放されたり、町の発展段階（荒野→集落→町→王都→天空）が進みます。\n'
              'ランクが高いクエストほど獲得町XPも多くなります（S:50 / A:30 / B:20 / C:10 / D:5）。',
        ),
      ],
    );
  }
