...
class PlayerStatusHeader extends StatelessWidget {
          ...
          child: Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("体調: ${viewModel.fatigueStatus}",
                      style: const TextStyle(fontWeight: FontWeight.bold)),
                  Text(
                      "本日の完遂: ${player.dailyTasksCompleted} / ${viewModel.fatigueSevereThreshold}",
              ...
              LinearProgressIndicator(
                ...
                valueColor: AlwaysStoppedAnimation<Color>(
                  viewModel.fatigueProgress >= 1.0
                      ? Colors.red
                      : viewModel.fatigueProgress >= 0.5
                          ? Colors.orange
                          : Colors.blue,
                ),
              ),
  ...
  Widget _buildFatigueGauge(GameViewModel viewModel) {
    final level = viewModel.fatigueLevel;
    final Color bgColor;
    ...
    return Wrap(
      ...
      children: [
        ...
        _buildMissionBadge(
          ...
          progress:
              viewModel.dailyMissionProgress / GameViewModel.dailyMissionGoal,
        ...
        _buildMissionBadge(
          ...
          progress:
              viewModel.weeklyMissionProgress / GameViewModel.weeklyMissionGoal,
