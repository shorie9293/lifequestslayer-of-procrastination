    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSkillRow('果てなき挑戦', 'Lv.10', '繰り返しクエスト登録。浪人Lv10でスロット+1。'),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _buildSkillRow('逆転の気魄', 'Lv.5', '疲労ゲージ逆転：クエスト消化で回復。'),
          const SizedBox(height: 12),
      ...
      child: Column(
        ...
        children: [
          const Text('🛡️ 法師のスキル',
              style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          _buildSkillRow('後追いの祈り', 'Lv.1', '毎日同じ時刻に繰り返しクエストを再生成。'),
          const SizedBox(height: 12),
          _buildSkillRow('微睡みの加護', 'Lv.5', '期限切れ間近のクエストを1日延期。'),
          const SizedBox(height: 12),
          _buildSkillRow('連続の誓い', 'Lv.10', 'クエスト連続完了記録。7日継続でXP1.2倍。'),
          const SizedBox(height: 12),
      ...
      child: Column(
        ...
        children: [
          const Text('🔮 陰陽師のスキル',
              style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          _buildSkillRow('分割の理', 'Lv.1', 'サブクエスト作成。サブクエスト完了でXP+30%。'),
          const SizedBox(height: 12),
          _buildSkillRow('札の掌握', 'Lv.5', 'タグによるクエスト分類・フィルタリング。'),
          const SizedBox(height: 12),
          _buildSkillRow('計画の陣', 'Lv.10', 'プロジェクト管理：複数クエストをグループ化。'),
          const SizedBox(height: 12),
