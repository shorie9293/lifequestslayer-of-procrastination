...
/// スキップ・不正解時はボーナスなし。
///
/// 注: 現在は [BattleReportDialog] にインライン統合されているため、
/// このファイルは直接参照されていない（互換性のため残してある）。
class KnowledgeQuestQuizDialog extends StatefulWidget {
  final QuizQuestion quest;
  final VoidCallback onCorrect;
  final VoidCallback onSkip;

  const KnowledgeQuestQuizDialog({
    super.key,
    required this.quest,
  ...
  static Future<void> show(
    ...
    return showDialog<void>(
      ...
      builder: (_) => KnowledgeQuestQuizDialog(
        quest: quest,
        onCorrect: onCorrect,
        onSkip: onSkip,
      ),
  ...
  @override
  State<KnowledgeQuestQuizDialog> createState() => _KnowledgeQuestQuizDialogState();
}

class _KnowledgeQuestQuizDialogState extends State<KnowledgeQuestQuizDialog> {
  int? _selectedIndex;
